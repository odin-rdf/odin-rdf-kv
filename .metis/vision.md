...
- KV-I-0003 (build step 4, delete with merge) was designed and decomposed on 2026-09-24 and is active: merge the sibling into the page on the path, no borrowing, empty pages always dropped, separators never rewritten.
- Delete (step 4, in progress), the memory budget (step 6) and crash testing (step 7) remain.
