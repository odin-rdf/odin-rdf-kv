...
- Backlog filed by KV-I-0005: `KV-T-0035` (bug, **an open owner decision**: a power loss during creation can leave a file that never opens), `KV-T-0034`, `KV-T-0036`, `KV-T-0037` (tech debt, test coverage).

**Next up:** the owner's call. All seven build steps are done. Open: the review of KV-I-0005, the decision in KV-T-0035, and the GitHub workflow (D9; the invocation is in KV-I-0005's Results).
