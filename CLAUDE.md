...
**Next up:** the owner's call. All seven build steps are done and KV-I-0005 is archived. Open: the sector-atomicity question (KV-T-0038), the GitHub workflow (D9; the invocation is in KV-I-0005's Results), and the test-coverage backlog (KV-T-0034, KV-T-0036, KV-T-0037).
